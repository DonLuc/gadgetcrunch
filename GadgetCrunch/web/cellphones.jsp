            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="stock.do?select=Wearable">Wearables</a>
                        </li>
                                            <li>
                            <a href="#">Contact Us</a>
                        </li>
                                            <li>
                                                ...
                                                <span class="glyphicon glyphicon-log-out white"></span>
												</a>
                                            </li>
                        <li>
                        </li>
						...
						%>
									<tr>
										...
										<td><%=phones.get(x).getGadget().getQuantity()%></td>
                                                                                ...
                                                                                <td>
                                                                                    <a class="btn btn-default" href="order.do?id=<%=phones.get(x).getID()%>&action=OrderNowPhone">Order Now</a>
                                                                                </td>
									</tr>
						<%
								}
