           ...
           <form action="order.do" method="GET">
				...
				<div class="table-responsive">
							...
							<th>Price (R)</th>
                                                ...
                                                <c:forEach var="item" items="${sessionScope.cart.gadgets}">
                                                    <tr>
                                                        ...
                                                        <td>
															<a href="order.do?action=RemoveItem&remCode=${item.gadget.modelCode}">
					...
					<div class="btn-group" role="group">
						...
						<a href="order.do?action=Check Out" class="btn btn-primary">Check Out
						...
						<!--<span class="glyphicon glyphicon-chevron-right">-->
						<a href="order.do?action=Clear Cart" class="btn btn-primary">Clear Cart
                                                <span class="glyphicon glyphicon-remove"></span>
                                                </a>
					</div>
