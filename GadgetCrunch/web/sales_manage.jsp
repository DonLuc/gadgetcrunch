...
<body ng-controller="RegistrationController as Registration" style="background: url('images/bgLight.jpg');">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
					...
					<li>
                        <a href="admin.do?select=Gadget Management">Gadget Management</a>
                    </li>
					<li>
    ...
    <div class = "container">
        ...
        <header class="jumbotron hero-spacer">
            <h1 align="center" style="font-family:Arial Rounded MT Bold; text-shadow:2px 2px 4px grey;" >Sales Management</h1>
